...
const DATA_OVERRIDE = {
  "02Genext": {
    ...
    "03": {"title":"Critical xxl AUTO GRANEL","genetica":"Autofloreciente","price":"99.000"}
  },
  "01Genint": {
...
function buildCarousel(rootId, folder){
  ...
  ['01','02','03'].forEach(id=>{
    ...
    // Auto Granel: solo títulos (sin especificaciones / precio)
    if(folder === '02Genext' && id === '03'){
      body.innerHTML = `
        <div class="ag-title-row">
          <h3 class="ag-title-main">${meta.title}</h3>
          <h3 class="ag-title-qty">x5 Semillas</h3>
        </div>`;
    }else{
